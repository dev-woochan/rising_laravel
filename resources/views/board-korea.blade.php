    ...
    <div class="container mx-auto w-3/5 mt-8">
        <div class="flex justify-between items-center mb-4 ">
            <div class="left_option">
                <form action="board_koreaStock.php" method="get" class="flex">
                    <input type="text" placeholder="종목명 검색" name="searchStock"
                        class="border border-gray-300 px-2 py-1 rounded-md mr-2">
        ...
        <section class="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-12">
            <section class="bg-white overflow-hidden shadow-sm sm:rounded-lg ">
                <div class="p-6 bg-red-400 border-b border-gray-200 "><a class="font-bold text-lg"
                        :href="route('home')">국내주식 게시판</a></div>
                <x-board-list>
